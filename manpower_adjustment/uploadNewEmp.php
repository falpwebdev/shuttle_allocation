                                                  ...
                                                  if(in_array($empShift,$shiftList)){
                                                    ...
                                                    if(in_array($empSt,$schedList)){
                                                      ...
                                                      if(in_array($empJobType,$jtList)){
                                                          ...
                                                          // Update/ Insert MP
                                                          if($action == 'update'){
                                                            $sqlAction = "UPDATE `a_m_employee_ADDEVEN` SET `empName`='$empName',`gender`='$gender',`dateHired`='$dateHired',`batchNo`='$batchNo',`empNickname`='$nickName',`empContact`='$contactNo',`empPosition`='$empPosition',`empCostCenter`='$costCenter',`empAgency`='$agency',`empDeptCode`='$deptCode',`empDeptSection`='$deptSection',`empSubSect`='$deptSubSection',`lineNo`='$lineNo',`empArea`='$empArea',`empRoute`='$empRoute',`empShift`='$empShift',`empShiftTime`='$empSt',`empHandler`='$empHandler',`status`='Active',`jobType`='$empJobType' WHERE `idNumber`= '$idNumber'";
                                                          }elseif ($action == 'insert') {
                                                            $sqlAction = "INSERT INTO `a_m_employee_ADDEVEN`(`idNumber`, `empName`, `gender`, `dateHired`, `batchNo`, `empNickname`, `empContact`, `empPosition`, `empCostCenter`, `empAgency`, `empDeptCode`, `empDeptSection`, `empSubSect`, `lineNo`, `empArea`, `empRoute`, `empShift`, `empShiftTime`, `empHandler`, `status`, `jobType`) VALUES ('$idNumber','$empName','$gender','$dateHired','$batchNo','$nickName','$contactNo','$empPosition','$costCenter','$agency','$deptCode','$deptSection','$deptSubSection','$lineNo','$empArea','$empRoute','$empShift','$empSt','$empHandler','Active','$empJobType')";
                                                          }
