...
<div class="container-fluid">
  <div class="row justify-start mt-5">
    <div class="col-lg-4 animated fadeInUp" id="sec">
      <div class="card">
        <div class="card-body">
        <div class="float-sm-right">
          <a href="index.php" class="btn btn-sm btn-primary waves-effect"><i class="fas fa-user" style="font-size:15px;"></i></a>
        </div>
          <form class="text-center border border-light p-5" id="frmLogin" action="functions/process/system_login.php" method="post">
            <p class="h4 mb-4">Shuttle Allocation System (Admin)</p>
            <?php
              if(isset($_GET['stat'])){
            ?>
            ...
            <div class="md-form">
              ...
              <!-- Sign in button -->
              <button class="btn btn-info" type="submit" name="adminLogin"><i class="fas fa-sign-in-alt fa-2x"></i></button>
          </form>
