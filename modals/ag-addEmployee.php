      ...
      <div class="modal-body">
        ...
        <div class="row mt-2">
          <div class="col-2">
            ...
            <input type="text" id="empAgency" class="form-control" disabled>
          </div>
          <div class="col mt-3">
            <div class="custom-control custom-checkbox mt-4">
              <input type="checkbox" class="custom-control-input" id="checkTempo">
              <label class="custom-control-label" for="checkTempo">Temporary</label>
            </div>
          </div>
          <div class="col-4">
